     ...
     <li class="nav-item dropdown">
       ...
       <?php if($num_notifications>0){ ?>
         ...
         <br>
          ...
          <div class="dropdown-divider"></div>
          <?php endforeach;?>
           <a href="modules/reservations/index.php" class="dropdown-item dropdown-footer">Ver todas las reservaciones</a>
          <?php }else{ ?>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <?php if ($_SESSION['idRol']==1 OR $_SESSION['idRol']==2 ){ ?>
              ...
              <?php }
               if ($_SESSION['idRol']==1 OR $_SESSION['idRol']==2 OR $_SESSION['idRol']==3){ ?>
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                <a href="modules/bedrooms_categories/index.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="modules/supplements/index.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="modules/food_plans/index.php" class="nav-link">
