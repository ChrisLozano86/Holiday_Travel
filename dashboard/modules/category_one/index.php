...
require_once '../../class/CategoriaUno.php';
include_once '../../assets/template/header.php';
$promociones = DestinosUno::recuperarTodos();
$categoria = CategoriaUno::recuperarTodos();
?>
...
<div class="content" id="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col">
        <h3 class="text-center"> Administrar Circuitos de Categoría 1</h3>
          ...
          <table class="table table-bordered" id="table-data">
            <thead class="thead-dark">
              <tr class="text-center">
                ...
                <th scope="col">Título del circuito</th>
            ...
            <tbody>
              <?php foreach ($promociones as $item) : ?>
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="delete.php?idSlider=<?php echo $item[0]; ?>" onclick="return confirm('¿Está seguro que desea eliminar esta tarjeta?')" class="btn btn-danger far fa-trash-alt"></a></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
