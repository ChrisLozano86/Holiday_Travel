      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <h4 class="text-center"><?php echo $title ?></h4> <br>
            ...
            <ul>
              <li><small>Dimensiones de 800*600 pixeles en formato JPG o PNG</small></li>
            ...
            <div class="form-group">
            <input type="submit" class="btn btn-default btn-custom" value="Guardar Tarjeta">
            </div>  
