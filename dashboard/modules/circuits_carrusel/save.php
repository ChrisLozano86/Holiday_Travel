      ...
      <div class="container-fluid">
        <div class="row">
          ...
          if (isset($_REQUEST['idSlider'])){
            ...
            $title = 'Crear nuevo elemento para carrusel';
          }
          ?>
          ...
          <h4 class="text-center"><?php echo $title ?></h4> <br>
            ...
            <input class="form-control" type="hidden" name="idSlider" id="idSlider" value="<?php echo $slider->getIdPromocion(); ?>">
            </div>
            ...
            <div class="form-group">
            <label for="url_img1">Imagen del buscador </label>
            <?php    if(isset($_REQUEST['idSlider'])): ?>
              </br>
            <img src="<?= $slider->getUrlImagen1(); ?>" style="width:100px" />
            </br></br>
            <?php endif; ?>
            <input type="file" class="form-control-file" name="url_img1" id="url_img1" <?php if($slider->getIdPromocion()==""){ echo 'required'; }?> >
            <small> Selecciona una imagen con las siguientes caracteristicas:</small>
            <ul>
              <li><small>Dimensiones de 800 x 600 pixeles en formato JPG</small></li>
