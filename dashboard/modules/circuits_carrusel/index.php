...
$slider = CircuitosCarrusel::recuperarTodos();
?>
...
<div class="content" id="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col">
        <h3 class="text-center"> Administrar Imagen Carrusel </h3>

        <a href="save.php" class="btn btn-default btn-custom" > <i class="fas fa-plus"></i> Agregar  imagen al carrusel </a><br><br>
          ...
          <table class="table table-bordered" id="table-data">
            <thead class="thead-dark">
              <tr class="text-center">
                ...
                <th scope="col">Imagen del carrusel</th>
            ...
            <tbody>
              <?php foreach ($slider as $item) : ?>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <?php if ($item['visible'] == 0) {
                          echo '<p class="alert alert-warning" ">Actualmente este elemento no es visible en el carrusel</p>';
                        } else {
                          echo '<p class="alert alert-success" ">Visible en el carrusel</p';
                        } ?> </p>
                      </div>
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="delete.php?idSlider=<?php echo $item[0]; ?>" onclick="return confirm('¿Está seguro que desea eliminar esta imagen?')" class="btn btn-danger far fa-trash-alt"></a></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
