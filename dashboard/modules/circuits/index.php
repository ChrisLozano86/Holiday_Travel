...
$slider = Circuito::recuperarTodos();
?>
...
<!-- Main content -->
    <div class="content" id="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col">
            <h3 class="text-center"> Administrar Circuitos </h3>
            
              <a href="save.php" class="btn btn-default btn-custom" > <i class="fas fa-plus"></i> Agregar nuevo circuito </a><br><br>
  ...
  <thead class="thead-dark">
    ...
    <th scope="col">Imagen del circuito</th>
...
<div class="modal fade" id="showDetailSlider<?php echo $item[0] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <br>
      <?php if($item['visible']==0){ echo '<p class="alert alert-warning" ">Actualmente este elemento no es visible </p>'; }else{ echo '<p class="alert alert-success" ">Circuito Visible</p'; } ?> </p>
      </div>
    ...
    <tr>
      ...
      <td class="text-center"><a href="delete.php?idSlider=<?php echo $item[0];?>" onclick="return confirm('¿Está seguro que desea eliminar este circuito?')" class="btn btn-danger far fa-trash-alt"></a></td> 
    </tr>
    <?php endforeach; ?>
  </tbody>
</table>
...
<?php else: ?>
            <p class="alert alert-info"> No se encontraron circuitos </p>
        <?php endif; ?>
